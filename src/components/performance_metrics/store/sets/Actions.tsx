...
export const changeJunior = getPayloadAction<string>(CHANGE_JUNIOR)
...
export const changeTrainee = getPayloadAction<string>(CHANGE_TRAINEE)
...
export const changeSecondShifts = getPayloadAction<string>(CHANGE_SECOND_SHIFTS)
