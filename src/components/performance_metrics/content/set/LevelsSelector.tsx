...
import { levelsSelector, levelsSelectorName } from '../../../common/store/multiset_container/sets/selectors/Employees'
...
export default function LevelsSelector() {
    ...
    const decompositionArgs = setDecomposition(setTitle, levelsSelectorName)
