...
import { fetchArray, getFetchResult } from '../../common/network_resource_fetcher/FetchOrDefault'
...
export async function fetchMetricDesc(): Promise<FetchResult<HelpItem>> {
    return getFetchResult(true, {
        title: '',
        content: ''
    })
}
